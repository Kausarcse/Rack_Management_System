...
*/
    ...
    $row_id = $_GET['row_id'];
    $row_id_travel_card_id = explode(" ",$row_id);
...
<script>
 function sending_data_of_edit_rework_wise_travel_card_form_for_saving_in_database()
 {


    //    var validate = Form_Validation();
       var validate = true;
       var url_encoded_form_data = $("#rework_wise_travel_card_edit_form").serialize(); //This will read all control elements value of the form	
       if(validate != false)
	   {


		  	 $.ajax({
			 		url: 'edit_rework_wise_travel_card_saving.php',
			 		dataType: 'text',
			 		type: 'post',
...
<form class="form-horizontal" action="" style="margin-top:10px;" name="rework_wise_travel_card_edit_form" id="rework_wise_travel_card_edit_form">
    ...
    <div class="form-group form-group-sm" id="form-group_for_to_date" style="margin-right:0px; color:#00008B;">
     ...
     <div class="form-group form-group-sm" id="form-group_for_travel_card_id">
                ...
                <div class="col-sm-5">
                    ...
                    <select  class="form-control for_auto_complete" id="travel_card_id" name="travel_card_id"> 
        ...
        <div class="form-group form-group-sm" id="form-group_for_po_number">
                ...
                <div class="col-sm-5">
                 <select  class="form-control" id="po_number" name="po_number"> 
                    ...
                    <input type="hidden" class="form-control" id="po_id" name="po_id" value="<?php echo $row1['po_number'] ?>" readonly>
        ...
        <div id="po_details_info">
            <div class="form-group form-group-sm" id="form-group_for_po_number">
                ...
                <label><span id="show"></span></label>
                    ...
                    <div class="col-sm-5">
                         <select  class="form-control" id="po_details" name="po_details">
       ...
       <div id="div_paper_type" >
          ...
          <div id="div_layout" >
                ...
                <div class="form-group form-group-sm" >
                  ...
                  <div class="col-sm-9 text-left">
                      <input class="form-control input-sm" type="text" id="layout" name="layout" value="<?php echo $row1['layout']?>" readonly>
                  </div>
                     ...
                     <!-- <div class="col-sm-1 text-center">
                            ...
                            <label class="control-label checkbox-inline" for="layout" >   
                               ...
                               <input type="checkbox" id="layout" name="layout[]" value="Dye Cutting">
                               <strong>Dye Cutting</strong>
                               </label> 
      ...
      <div id="div_measurement_of_carton" >
          ...
          <div class="form-group form-group-sm" >
                ...
                <div class="col-sm-1 text-center">
                    ...
                    <input class="form-control input-sm" type="text" id="liner_consumption_calc" name="liner_consumption_calc" value="1" readonly>
                ...
                <div class="col-sm-1 text-center">
                    ...
                    <input class="form-control input-sm" type="text" id="media_consumption_calc" name="media_consumption_calc" value="1" readonly>
                ...
                <div class="col-sm-1 text-center">
                   ...
                   <input class="form-control input-sm" type="text" id="sqm_consumption_calc" name="sqm_consumption_calc" value="1" readonly>
      ...
      <div><label class="form-control">Process Information</label> </div>
         ...
         <div class="form-group form-group-sm" id="form-group_for_process_name">
                ...
                <div class="col-sm-5">
                          <?php //onchange="returning_before_quantity_for_travel_card(this.value)"
                              $sql = "select process_name,before_process_quantity,process_quantity,process_wastage from `travel_card_details_for_transactions` where row_id='$row_id'";
                              $result= mysqli_query($con,$sql) or die(mysqli_error($con));
                              $process_info = mysqli_fetch_array( $result);
                              

                          ?>
                    <select  class="form-control" id="process_name" name="process_name" >
                                <option select="selected" value="<?php echo $row1['process_name'].'"?fs?'.$row1['process_id']?>"><?php echo $process_info['process_name']?></option>
                                <?php 
        ...
        <div class="form-group form-group-sm" id="form-group_for_process_wastage">
            ...
            <div class="col-sm-5">
                             ...
                             <input type="text" class="form-control" id="process_wastage" name="process_wastage" value="<?php echo $process_info['process_wastage']?>" >
               
            </div>
            <i class="glyphicon glyphicon-remove" onclick="Remove_Value_Of_This_Element('process_wastage')"></i>
        </div> <!-- End of <div class="form-group form-group-sm" id="form-group_for_po_creation"> -->   
         ...
         <div class="form-group form-group-sm">
                <div class="col-sm-offset-3 col-sm-5">
                    <button type="button" class="btn btn-primary" onClick="sending_data_of_edit_rework_wise_travel_card_form_for_saving_in_database()">Update</button>
