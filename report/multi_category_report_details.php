...
if ($work_order_number == 'Select Work Order Number') 
{
	$work_order_number = '';
}

if ($customer_name == 'Select Customer Name') 
{
	$customer_name = '';
}

// if ($shade == 'Select Shade') 
// {
// 	$shade = '';
// }

// if ($weave == 'Select Weave') 
// {
// 	$weave = '';
// }
...
{
	$sql.=" AND transaction_date BETWEEN '".$date_form."' AND '".$date_to."'";
}

if ($work_order_number != '') 
{
	$sql.=" AND work_order_number = '".$work_order_number."'";
}
