    ...
    ?>
                    ...
                    <tr>
                        ...
                        <td style="border: 1px solid black;">
                            ...
                            <!-- <a  onClick="load_page('report/unloading_maping_report_update.php?id=<?php  ?>')" ><button class="btn btn-warning btn-xs" id="travel_card_pdf_generation" id="travel_card_pdf_generation">  Edit</button></a> -->
                        </td>                    
