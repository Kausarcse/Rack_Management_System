...
$sql1 = "SELECT 
        *
        FROM unloading_plan
        WHERE date_of_delivery = '$date_of_delivery' and active = '1' 
        ";
...
{  
    ...
    ?>
                    ...
                    <tr>
                        ...
                        <td style="border: 1px solid black;">
                            <!-- <a  onClick="load_page('report/unloading_maping_report.php')" ><button class="btn btn-warning btn-xs" id="travel_card_pdf_generation" id="travel_card_pdf_generation">  Edit</button></a> -->
                            
                            <a  onClick="load_page('report/unloading_maping_report_update.php?id=<?php echo $id; ?>')" ><button class="btn btn-warning btn-xs" id="travel_card_pdf_generation" id="travel_card_pdf_generation">  Edit</button></a>
                        </td>                    
