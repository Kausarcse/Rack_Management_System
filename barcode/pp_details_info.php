	...
	else
	{
		...
		?>
			...
			<div class="form-group form-group-sm" id="form-group_for_provided_to">
				...
				<div class="col-sm-5" style="padding-right:4px;">
					<input type="text" class="form-control" id="finished_type" name="order_quantity" value="<?php echo $order_quantity; ?>" readonly>
				</div>
			...
			<div class="form-group form-group-sm" id="form-group_for_provided_to">
				...
				<div class="col-sm-5" style="padding-right:4px;">
					<input type="text" class="form-control" id="roll_no" name="roll_no" placeholder="Enter Roll No" onchange="work_order_and_roll_wise_packing_list_data(this.value)" required>
				</div>
			...
			<div class="form-group form-group-sm" id="form-group_for_provided_to">
				...
				<div class="col-sm-5" style="padding-right:4px;">
					<input type="text" class="form-control" id="kgs" name="kgs" placeholder="Enter Kgs" readonly>
				</div>
			...
			<div class="form-group form-group-sm" id="form-group_for_provided_to">
				...
				<div class="col-sm-5" style="padding-right:4px;">
					<input type="text" class="form-control" id="length" name="length" placeholder="Enter Length" required readonly>
				</div>
			...
			<div class="form-group form-group-sm" id="form-group_for_provided_to">
				<label class="control-label col-sm-2" for="pallet_no" style="color:#00008B;">Pallet No.:</label>
				<div class="col-sm-5" style="padding-right:4px;">
					<input type="text" class="form-control" id="pallet_no" name="pallet_no" placeholder="Enter Pallet No" required>
				</div>

				<i class="glyphicon glyphicon-remove" onclick="Remove_Value_Of_This_Element('pallet_no')" style="margin-top:6px;"></i>
			</div>

			<div class="form-group form-group-sm" id="form-group_for_type">
				<label class="control-label col-sm-2" for="type" style="color:#00008B;">Type:</label>
				<div class="col-sm-5" style="padding-right:4px;">
					<select class="form-control for_auto_complete" id="type" name="type">
						<option select="selected" value="select">Select Type</option>
			...
			<div class="form-group form-group-sm">
				<div class="col-sm-offset-1 col-sm-5">
				    ...
				    <input class="btn btn-success" id="create_pdf" value="Barcode" onClick="create_barcode_pdf()">
