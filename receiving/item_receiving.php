...
function barcode_change()
{
	var barcode_code = document.getElementById("barcode_code").value;
 	$.ajax({
	 		url: 'receiving/item_details.php',
	 		dataType: 'text',
	 		type: 'post',
 ...
 function sending_data_of_item_receiving_form_for_saving_in_database()
 {
       ...
       if(validate != false)
	   {
			...
			var style_no=document.getElementById('style_no').value;
		  	 ...
		  	 $.ajax({
			 		url: 'receiving/item_receiving_saving.php',
			 		dataType: 'text',
			 		type: 'post',
			 		contentType: 'application/x-www-form-urlencoded',
			 		data: {barcode_code: barcode_code, receiving_location: receiving_location, received_by: received_by, date_of_receipt: date_of_receipt, row_number: row_number, rack_number: rack_number, cubic_number: cubic_number, bin_card_number: bin_card_number, quantiy: quantiy, uom: uom, roll_no: roll_no, pp_number: pp_number, work_order_number: work_order_number, gd_number: gd_number, customer_name: customer_name, buyer: buyer, shade: shade, construction: construction, composition: composition, weave: weave, length: length,kgs: kgs,pallet_no: pallet_no, finished_width: finished_width, finished_type: finished_type,type: type, grade: grade, ac_holder:ac_holder, order_qty:order_qty, allownce:allownce, rate:rate, process:process, pi_no:pi_no, cut_width:cut_width, style_no:style_no},
			 		success: function( data, textStatus, jQxhr )
			 		{
			 				alert(data);
  ...
  function send_rack_number_to_find_row()
  {
	  var rack_number = document.getElementById("rack_number").value;

 	    $.ajax({
				url: 'receiving/rack_receving_to_find_row_number.php',
				dataType: 'text',
				type: 'post',
				contentType: 'application/x-www-form-urlencoded',
  ...
  function rack_number_and_row_number_for_cubic_number_generation()
  {
	...
	var cubic_number = rack_number + row_number;
		...
		$.ajax({
			url: 'receiving/return_cubic_number_from_rack_and_row_number.php',
			dataType: 'text',
			type: 'post',
			contentType: 'application/x-www-form-urlencoded',
...
<div class="col-sm-12 col-md-12 col-lg-12">
		...
		<div class="panel panel-default"> <!-- This div will create a block/panel for FORM -->
				...
				<div class="panel-heading" style="color:#191970;"><b>Item Receiving</b></div> <!-- This will create a upper block for FORM (Just Beautification) -->
				...
				<form class="form-horizontal" action="" style="margin-top:10px;" name="item_receiving_form" id="item_receiving_form">
                  ...
                  <div class="form-group form-group-md" id="form-group_for_rack_number">
					 <label class="control-label col-md-3" for="rack_number" style="margin-right:0px; color:#00008B;">Rack Number:</label>
						<div class="col-md-5 field_container">
							<select  class="form-control for_auto_complete" id="rack_number" name="rack_number" onchange="send_rack_number_to_find_row()">
										<option selected="selected" value="select">Select Rack Number</option>
										<?php 
                     ...
                     <div id="row_number_change">
						<div class="form-group form-group-md" id="form-group_for_row_number">
								...
								<div class="col-md-5 field_container">
									<input type="text" class="form-control" id="row_number" name="row_number" placeholder="Enter Row Number">
								</div>
                   ...
                   <div id="cubic_number_change">
					 <div class="form-group form-group-md" id="form-group_for_cubic_number">
							...
							<div class="col-md-5 field_container">
								<input type="text" class="form-control" id="cubic_number" name="cubic_number" placeholder="Enter Rack Qubic Number" required>
							</div>
					...
					<div class="form-group form-group-md">
							<div class="col-sm-offset-3 col-md-5">
								<button type="button" class="btn btn-primary" onClick="sending_data_of_item_receiving_form_for_saving_in_database()">Submit</button>
